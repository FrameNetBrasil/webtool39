...
HERE;
    ...
    public function listSentencesByAS($idAnnotationSet) {
        $criteria = $this->getCriteria()->
        select('idAnnotationSet, idSentence, sentence.text, annotationstatustype.entries.name as annotationStatus, idAnnotationStatus, annotationstatustype.color.rgbBg');
        ...
        Base::entryLanguage($criteria,'annotationstatustype');
        return $criteria;
    }
