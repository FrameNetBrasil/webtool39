...
//        ]],
        'annotation' => ['Annotation', 'annotation/main', 'fa fa-align-justify fa16px', 'MASTER', 'A_ACCESS', [
...
//            'dynamicAnnotation' => ['Dynamic Mode', 'annotation/dynamic/formVideoAnnotation', 'fa fa-file-video fa16px', '', A_ACCESS, []],
            'staticAnnotation' => ['Static Mode', 'annotation/static/formImageAnnotation', 'fa fa-camera fa16px', 'MASTER', A_ACCESS, []],
...
//        ]],
        'language' => ['Language', 'main/language', 'fa fa-flag-checkered fa16px', '', '', [
            ...
            'en' => ['English', 'main/changeLanguage/en', 'fnbrFlagEn', '', '', []],
            //'fi' => ['Finnish', 'main/changeLanguage/fi', 'fnbrFlagFi', '', A_ACCESS, []],
            'fr' => ['French', 'main/changeLanguage/fr', 'fnbrFlagFr', '', '', []],
            ...
            'jp' => ['Japanese', 'main/changeLanguage/jp', 'fnbrFlagJp', '', '', []],
            ...
            'pt' => ['Portuguese', 'main/changeLanguage/pt', 'fnbrFlagPt', '', '', []],
            'es' => ['Spanish', 'main/changeLanguage/es', 'fnbrFlagEs', '', '', []],
        ...
        'profile' => ['Profile', 'main/profile', 'fa fa-info fa16px', '', '', [
            'myprofile' => ['My Profile', 'profile/formMyProfile', 'fa fa-credit-card fa16px', '', '', []],
            'logout' => ['Logout', 'main/logout', 'fa fa-sign-out fa16px', '', '', []],
        ]],
    ]]
];
